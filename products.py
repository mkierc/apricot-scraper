product_dict = {
    ...
    # '1. Gigabyte GTX 1080 Xtreme': '',
    # '2. EVGA GTX 980 Ti Hybrid': '',
    # '3. EVGA GTX 980 Hybrid': '',
    # '4. EVGA GTX 970 Hybrid': '',
    # '5. Palit GTX 1080 ECO': '',
    # '6. MSI GTX 980 Ti ECO': '',
    # '7. Gainward GeForce GTX 980': '',
    # '8. Gigabyte GTX 970 ECO': ''
}
